...
const SushiPoolMiner = require('./src/PoolMiner.js');
...
const TAG = 'Miner';
const $ = {};
const defaultConfigFile = 'miner.conf';
...
(async () => {
    ...
    Nimiq.Log.i(TAG, `NodeJsPool Miner ${pjson.version} starting`);
    ...
    Nimiq.Log.i(TAG, `- Provided by sushipool.com`);
